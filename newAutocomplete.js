...
// const Autocomplete = (rootEl, info, options = {}) => {
...
// Autocomplete.prototype.compileURL = (query, numOfResults, keys) => {
...
// Autocomplete.prototype.onQueryChange = (query) => {
...
/*
1. new instance of Autocomplete created...
    - rootEl, options = {} passed through
    - options = {numOfResults, data, onSelect}
    - this.init(); called

2. this.inputEl calls creatQueryInputEl();
    - creates <input> 
